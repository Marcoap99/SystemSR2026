...
const UNIFORMS = {
  colors: [[0.8784313725490196,0.8941176470588236,1],[0.8980392156862745,0.9137254901960784,1],[0.9411764705882353,0.9490196078431372,1],[0.9411764705882353,0.9490196078431372,1],[0.9411764705882353,0.9490196078431372,1],[0.9411764705882353,0.9490196078431372,1],[0.9411764705882353,0.9490196078431372,1],[0.9411764705882353,0.9490196078431372,1]] as [number, number, number][],
  colorCount: 4,
  scale: 1.260,
  intensity: 0.280,
  paramA: 0.500,
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    function render(now: number) {
      ...
      resizeCanvas()
      // Non-null: `canvas`/`gl` are narrowed by the early returns at the top
      // of the effect, but `function render` is hoisted, so TS can't carry
      // that narrowing into this closure on its own.
