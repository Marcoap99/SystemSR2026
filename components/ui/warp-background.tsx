...
const Beam = ({
  ...
  // Inicializador perezoso: Math.random() corre una sola vez por beam
  // montado, no en cada render (regla de pureza del linter -- también
  // es lo correcto acá, el color/aspect-ratio de un beam no debería
  // cambiar solo porque el padre volvió a renderizar).
